...
@section('panel_content')
    <div class="aiz-titlebar mt-2 mb-4">
      <div class="row align-items-center">
        <div class="col-md-6">
            <h1 class="h3">{{ translate('Upload Verified Documents Such as CNIC,BANK STATEMENT AND HEC VERIFIED DEGREE') }}</h1>
        </div>
      </div>
    </div>
        ...
        <div class="col-md-5 mx-auto mb-3" >
          <div class="bg-grad-1 text-white rounded-lg overflow-hidden">
            ...
            <div class="px-3 pt-3 pb-3">
                ...
                <div class="opacity-50 text-center">{{ translate('Remaining Verified Image Upload') }}</div>
            </div>
          </div>
        </div>
        <div class="col-md-5 mx-auto mb-3" >
            <a href="{{ route('gallery-image.create')}}">
                <div class="p-3 rounded mb-3 c-pointer text-center bg-white shadow-sm hov-shadow-lg has-transition">
                    ...
                    <div class="fs-18 text-primary">{{ translate('Add New Image of Documents') }}</div>
                </div>
            </a>
        </div>
    </div>
