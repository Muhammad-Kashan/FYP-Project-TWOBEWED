<head>
    ...
    <link href="css/style-start.css" rel="stylesheet" />
    ...
    <div class="container-fluid px-0">
        <div class="bottomhny-grids-sec">
            ...
            <div class="bottomhny-1 bottomhny-2">
                <div class="bottomhny-gd-ingf">
                    <h4>Caring For Your Relation The Way You Would.</h4>
                </div>
            </div>
    ...
    <div class="content-3-mian py-5">
        <div class="container py-lg-5">
            <div class="content-info-in row">
                <div class="col-lg-6">
                    <img src="images/abc1.jpg" alt="" class="img-fluid">
                </div>
                <div class="col-lg-6 mt-lg-0 mt-5 about-right-faq align-self  pl-lg-5">
                    <div class="title-content text-left mb-2">
                        <h6 class="sub-title">Who We Are</h6>
                        <h3 class="hny-title">
                            A Trusted Matrimonial Service for Finding Your Soulmate
                        </h3>
                    </div>
                    <p class="mt-3">
                        We are a dedicated and professional matrimonial service, committed to helping individuals find their soulmate and build a lifelong partnership. Our team of experienced matchmakers understand the importance of finding a compatible match and strive to provide a personalized and seamless experience for each of our clients.
                    </p>
    ...
    <div class="features4-block py-5">
        <div class="container py-lg-4">
            <div class="title-content text-center mb-lg-5 mt-4">
                ...
                <h3 class="hny-title">Great matching service</h3>
                <p class="fea-para">We believe that every person deserves to find happiness</p>
            </div>  
                ...
                <div class="col-lg-3 col-md-6 features4-grid mt-4">
                    <div class="features4-grid-inn">
                        ...
                        <div class="features4-rightinfo">
                            <h5><a href="#URL">Safe Enviroment</a></h5>
                            <p>We provide our clients a safe platform.</p>
                ...
                <div class="col-lg-3 col-md-6 features4-grid mt-4">
                    <div class="features4-grid-inn">
                        ...
                        <div class="features4-rightinfo">
                            ...
                            <p>There will be only verified individual available on our platform.</p>
                ...
                <div class="col-lg-3 col-md-6 features4-grid mt-4">
                    <div class="features4-grid-inn">
                        ...
                        <div class="features4-rightinfo">
                            ...
                            <p>On our platform there are mostly qualified individuals</p>
                ...
                <div class="col-lg-3 col-md-6 features4-grid mt-4">
                    <div class="features4-grid-inn">
                        ...
                        <div class="features4-rightinfo">
                            ...
                            <p>Client satisfaction and security is our first priority</p>
